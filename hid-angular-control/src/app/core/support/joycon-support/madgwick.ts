 ...
 */
export function Madgwick(sampleInterval: any, options: any) {
  //---------------------------------------------------------------------------------------------------
  // Definitions
   ...
   */
  function madgwickAHRSUpdate(gx, gy, gz, ax, ay, az, mx = undefined, my = undefined, mz = undefined, deltaTimeSec = undefined) {
